...
export class Paper {
    ...
    relevantPapers: {overview: number[]|null, challenge: number[]|null, approach: number[]|null, outcome: number[]|null}
    ...
    getNamedEntities() {
        return Object.values(this.materialEntities).flat().concat(
